# Disclaimer & Acceptable Use — vibe-sunsang

`vibe-sunsang` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`vibe-sunsang` is a general-purpose developer tool. Like most general-purpose tools, it
